...
import com.team.house.housebackapi.entity.StreetExample.Criteria;
import com.team.house.housebackapi.entity.StreetExample.Criterion;
...
public class StreetSqlProvider {
    ...
    public String insertSelective(Street record) {
        ...
        if (record.getDistrictId() != null) {
            VALUES("DISTRICT_ID", "#{districtId,jdbcType=INTEGER}");
        }
        
        return SQL();
    }

    public String selectByExample(StreetExample example) {
        BEGIN();
    ...
    protected void applyWhere(StreetExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
