...
import com.team.house.housebackapi.entity.UsersExample.Criteria;
import com.team.house.housebackapi.entity.UsersExample.Criterion;
...
public class UsersSqlProvider {
    ...
    public String insertSelective(Users record) {
        ...
        if (record.getIsadmin() != null) {
            VALUES("ISADMIN", "#{isadmin,jdbcType=INTEGER}");
        }
